...
import com.example.jbtang.agi_4buffer.dao.cellinfos.CellInfoDAO;
import com.example.jbtang.agi_4buffer.dao.cellinfos.CellInfoDBManager;
import com.example.jbtang.agi_4buffer.dao.confirmed.ConfirmedDAO;
import com.example.jbtang.agi_4buffer.dao.confirmed.ConfirmedDBManager;
...
import com.example.jbtang.agi_4buffer.service.CellMonitor;
...
public class CellMonitorActivity extends AppCompatActivity {
    ...
    private final static String CONFIG_DERECTORY = "cellmonitor";
    ...
    public void initData() {
        ...
        if(sharedPreferences.getString(MANUALCHOOSE,"false").equals("true")){
            manualChoose.setChecked(true);
        } else {
            manualChoose.setChecked(false);
        }
        manualEARFCN.setText(sharedPreferences.getString(MANUALEARFCN,""));
        manualPCI.setText(sharedPreferences.getString(MANUALPCI,""));
        if(sharedPreferences.getString(ALARMCHOOSE,"false").equals("true")){
            alarmChoose.setChecked(true);
        } else {
            alarmChoose.setChecked(false);
        }
        alarmTAC.setText(sharedPreferences.getString(ALARMTAC,""));
        alarmECGI.setText(sharedPreferences.getString(ALARMECGI,""));
