package com.example.jbtang.agi_4buffer.utils;
...
public class BarChartView {
    ...
    public void initData(int[] puschList, List<String> option, String title, int maxIndex) {
        values.add(puschList);
        mTitle = title;
        this.option = option;
//        if (maxIndex >= 0 && maxIndex < colors.length)
//            colors[maxIndex+1] = Color.YELLOW;
    }

    public View getBarChartView() {
        buildBarRenderer();
        setChartSettings(renderer, mTitle, "", "", 0, 5, 0, 100, Color.BLACK, Color.BLACK);
